...
export function Condiciones() {
    return (
        <section className='container'>
            <Helmet>
                <title>📜 Terminos y Condiciones | Stania Clothing</title>
                <meta name='description' content='Terminos y condiciones de Stania Clothing' />
            </Helmet>
            <Fade bottom>
            ...
            <div className='containerPage'>
                <Fade bottom>
                    ...
                    <p className='paragrath'>A menos que se indique lo contrario, Stania Clothing y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Stania Clothing. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Stania Clothing para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>
                    <p className='paragrahtTitle'>No debes:</p>
                    <ul> 
                        <Fade bottom>
                            <li className='paragrath paragrathList'>- Copiar o volver a publicar material de Stania Clothing</li>
                            <li className='paragrath paragrathList'>- Vender, alquilar o sublicenciar material de Stania Clothing</li>
                            <li className='paragrath paragrathList'>- Reproducir, duplicar o copiar material de Stania Clothing</li>
                            <li className='paragrath paragrathList'>- Redistribuir contenido de Stania Clothing</li>
                            <li className='paragrath paragrathList'>- Este acuerdo comenzará el fecha presente.</li>
                        </Fade>
                    </ul>
                    <p className='paragrath'>Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Stania Clothing no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Stania Clothing, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Stania Clothing no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.</p>
                    <p className='paragrath'>Stania Clothing se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.</p>
                    ...
                    <ul>
                        <Fade bottom>
                            ...
                            <li className='paragrath paragrathList'>- Por la presente, otorgas a Stania Clothing una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.</li>
                        </Fade>
                    </ul>
                    ...
                    <p className='paragrath'>Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Stania Clothing. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.</p>
