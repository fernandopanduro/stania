    ...
    return (
        <section className='container'>
            ...
            <div className='containerPage'>
                <Fade bottom>
                    <p className='paragrath'>El sitio web Stania Clothing es propiedad de Stania Clothing, que es un controlador de datos de tus datos personales.</p>
                    <p className='paragrath'>Hemos adoptado esta Política de privacidad, que determina cómo procesamos la información recopilada por Stania Clothing, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de Stania Clothing.</p>
