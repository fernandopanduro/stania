    ...
    return (
        ...
        <div className='containerPage'>
            <Fade bottom>
                ...
                <p className='paragrath'>Puedes informarnos por correo electrónico contacto@StaniaClothing.com</p>
                ...
                <p className='paragrath'>Si tienes alguna pregunta sobre nuestra Política de devoluciones y reembolsos, comunícate con nosotros por correo electrónico contacto@StaniaClothing.com</p>
            </Fade>
        </div>
    </section>
    )
